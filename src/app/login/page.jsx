...
export default function LoginPage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (rol === 'superAdmin') router.push('/super-admin');
      else if (rol === 'admin' || rol === 'vendedor') router.push('/admin');
      else router.push('/');
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-bg px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-brand-text">Iniciar sesión</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/reset-password" className="text-xs text-brand-primary hover:underline">
